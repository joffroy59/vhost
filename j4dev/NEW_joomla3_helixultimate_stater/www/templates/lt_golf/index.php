...
if (file_exists($helix_path)) {
    ...
    die('Install and activate <a target="_blank" href="https://www.joomshaper.com/helix">Joomla template Framework</a>.');
}
...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
    <head>
        ...
        <?php
            ...
            // CSS files custom
            $theme->add_css('default.css');
            $theme->add_css('hikashop.css');
            $theme->add_css('color-preset.css');
            // JS files
            $theme->add_js('jquery.sticky.js, main.js, custom.js, jquery.magnific-popup.js');
