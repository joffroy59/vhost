...
<body <?php echo $gantry->displayBodyTag(); ?>>
	...
	<div id="rt-showcase">
		<div class="rt-showcase-pattern">
			<div class="rt-container<?php if ($gantry->countModules('feature')) : ?> with-feature<?php endif; ?>">
	...
	<div id="rt-transition"<?php if ($gantry->get('loadtransition')) echo $hidden; ?>>
		<div id="rt-mainbody-surround">
			...
			<div id="rt-feature">
				<div class="rt-container<?php if ($gantry->countModules('showcase')) : ?> with-showcase<?php endif; ?>">
