	...
	public function save($key = null, $urlVar = null) {
		...
		switch ($task) {
			case 'apply':
				...
				// Preview URL
				$preview_link = 'index.php?option=com_sppagebuilder&view=page&id=' . $recordId . $Itemid;
				...
				$output['preview_url'] = SppagebuilderHelper::getSef404Url($siteRouter, $preview_link);
				$output['frontend_editor_url'] = SppagebuilderHelper::getSef404Url($siteRouter, $front_link);
