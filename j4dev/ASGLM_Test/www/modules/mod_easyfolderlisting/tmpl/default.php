...
<table class="easyfolderlisting<?php echo $params->get('moduleclass_sfx');?>" style="width:100%; border-collapse:separate; border-spacing:1px; background-color:<?php echo $params->get('efl_bordercolor');?>; text-align:left;">
	<tr style="background-color:<?php echo $params->get('efl_headcolor');?>;">
		<th style="border: 1px solid #FFFFFF; padding: 4px;"><?php echo Text::_('MOD_EFL_FILENAME');?></th>
		<?php if ($params->get('efl_size') == true) : ?>
		<th style="border: 1px solid #FFFFFF; padding: 4px;"><?php echo Text::_('MOD_EFL_SIZE');?></th>
		<?php endif; ?>
		<?php if ($params->get('efl_date') == true) : ?>
		<th style="border: 1px solid #FFFFFF; padding: 4px;"><?php echo (($params->get('efl_time') == true) ? Text::_('MOD_EFL_DATETIME') : Text::_('MOD_EFL_DATE')); ?></th>
		<?php endif; ?>
	</tr>
